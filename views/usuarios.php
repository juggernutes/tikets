...
// Filtra por texto libre en Nombre, Usuario, Rol
if ($q !== '') {
        ...
        <div class="toolbar">
            <form method="get" style="display:flex;gap:10px;flex-wrap:wrap;align-items:end">
                <div class="field">
                    ...
                    <input type="text" id="q" name="q" value="<?= e($q) ?>" placeholder="Nombre, Usuario, Rol">
                </div>
                <div class="field">
                    ...
                    <?php else: ?>
                        <?php foreach ($view as $usuario): ?>
                            <tr>
                                ...
                                <td>
                                    <form action="../app/appTiket.php?action=resetPasswordUsuario" method="post">
