  ...
  <div class="card">
    ...
    <div class="card-body">
      <div class="grid">
        ...
        <div class="item">
          <span class="label">Fecha de asignacion</span>
          <div class="value">
            <?= $ticket['FECHA_ASIGNACION'] ? fmtDate($ticket['FECHA_ASIGNACION']) : 'No asignado'?>
          </div>
        </div>
    ...
    <div class="actions">
      ...
      <a href="../app/appTiket.php?accion=activarTiket&id_tiket=<?= urlencode((string)($ticket['ID_Tiket'] ?? '')) ?>" class="btnx primary">Activar</a>
      <?php endif; ?>
      <?php if (($ticket['ESTADO'] ?? '') !== 'CERRADO'): ?>
